...
rm -f -- "$PREFIX/share/icons/hicolor/scalable/apps/caelestia-webapps.svg"
rm -f -- "$PREFIX/share/licenses/caelestia-webapps/LICENSE"
rmdir --ignore-fail-on-non-empty "$PREFIX/share/icons/hicolor/scalable/apps" 2>/dev/null || true
rmdir --ignore-fail-on-non-empty "$PREFIX/share/icons/hicolor/scalable" 2>/dev/null || true
